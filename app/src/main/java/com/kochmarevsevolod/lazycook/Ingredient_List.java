   ...
   /* @Override
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.recipes_page) {
            Intent intent = new Intent(Ingredient_List.this, Recipes_List.class);
            startActivity(intent);
            this.finish();
        } else if (id == R.id.search_page) {
            Intent intent = new Intent(Ingredient_List.this, Search_Page.class);
            startActivity(intent);
            this.finish();
        } else if (id == R.id.favorites_page) {
			Intent intent = new Intent(Ingredient_List.this, Favorites_List.class);
            startActivity(intent);
            this.finish();
        }
